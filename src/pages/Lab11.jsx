...
import Task111 from "../components/lab11_components/Task111.jsx";
import Task112 from "../components/lab11_components/Task112.jsx";
import Task113 from "../components/lab11_components/Task113.jsx";




const tasks = [
    {id: 1, title: "Тема мета ЛР №9 Місце розташування сайту, звіту", component: <Task111/>},
    {id: 2, title: "Виконання", component: <Task112/>},
    {id: 3, title: "Висновки", component: <Task113/>},
];
...
const Lab11 = () => {
    ...
    return (
        <div>
            <h1 className="text-4xl font-bold text-center mt-8 mb-8">lab9</h1>
