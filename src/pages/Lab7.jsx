...
import Task71 from "../components/lab7_components/Task71.jsx";
import Task72 from "../components/lab7_components/Task72.jsx";
import Task73 from "../components/lab7_components/Task73.jsx";


const tasks = [
    {id: 1, title: "Тема мета ЛР №5.2 Місце розташування сайту, звіту", component: <Task71/>},
    {id: 2, title: "Виконання", component: <Task72/>},
    {id: 3, title: "Висновки", component: <Task73/>},
];
...
const Lab7 = () => {
    ...
    return (
        <div>
            <h1 className="text-4xl font-bold text-center mt-8 mb-8">lab5.2</h1>
